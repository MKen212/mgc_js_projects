...
This Display class contains an updated drawPlayer() method that uses Math.round() instead
of Math.floor() which better presents where the player is actually standing.
*/
